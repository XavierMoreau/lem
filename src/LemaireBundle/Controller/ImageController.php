...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $images = $em->getRepository('LemaireBundle:Image')->findAll();
    ...
    {
        $image = new Image();
        $form = $this->createForm('LemaireBundle\Form\ImageType', $image);
    ...
    {
        $deleteForm = $this->createDeleteForm($image);
        $editForm = $this->createForm('LemaireBundle\Form\ImageType', $image);
